defmodule DirGraph.AnalyzerTest do
  ...
  setup do
    g =
      ...
      |> CG.add_node("Function:login/2",        "Function", "login/2",          %{file: "auth.ex", line: 5, end_line: 10})
      |> CG.add_node("Function:verify_token/1", "Function", "verify_token/1",   %{file: "auth.ex", line: 12, end_line: 18})
      |> CG.add_node("Function:hash/1",         "Function", "hash/1",           %{file: "auth.ex", line: 20, end_line: 21})
      |> CG.add_node("Call:verify_password",    "Call",     "verify_password",  %{file: "auth.ex", line: 7})
    ...
    test "include_code: true embeds source lines when file exists", %{graph: _g} do
      ...
      g2 =
        ...
        |> CG.add_node("Function:hash/1", "Function", "hash/1",
            %{file: auth_path, line: 21, end_line: 21})
